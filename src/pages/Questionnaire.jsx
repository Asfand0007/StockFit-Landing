...
function normalizeQuestionsPayload(payload) {
  ...
  return items
    .map((item) => ({
      ...
      options: Array.isArray(item.question_options) ? item.question_options : [],
    }))
...
export default function Questionnaire() {
  ...
  if (!stages.length || !currentQuestionData) {
    return (
      <div className="min-h-screen w-full font-montserrat bg-[#0a0c0b] text-white overflow-hidden">
        <Navbar />
        <div className="relative pt-28 px-6 pb-16 max-w-5xl mx-auto">
          ...
          >
            <p className="text-center text-red-400">
              The questionnaire data does not match the expected stage mapping.
            </p>
  ...
  return (
    <div className="min-h-screen w-full font-montserrat bg-[#0a0c0b] text-white overflow-hidden">
      ...
      <div className="relative pt-28 px-6 pb-16 max-w-5xl mx-auto">
        <div className="absolute -right-[14%] -top-[16%] h-105 w-105 rounded-full bg-primary opacity-15 blur-[150px] pointer-events-none" />
        <div className="absolute -left-[12%] bottom-[8%] h-90 w-90 rounded-full bg-secondary opacity-10 blur-[120px] pointer-events-none" />
